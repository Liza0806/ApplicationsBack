...
const testTaskSchemaJoi = Joi.object({
    ...
    status: Joi.string().valid("Отправлено", "Принято", "Проверяется", "Не принято"),
});
const jobApplicationSchema = Joi.object({
    ...
    status: Joi.string()
        .valid("Откликнулся", "Пригласили на интервью", "Прошёл HR", "Прошёл тех", "Прошёл все интервью", "Ожидание ответа", "Оффер", "Отказ", "Не откликнулся")
        .required(),
...
//# sourceMappingURL=testTaskSchemaJoi.js.map